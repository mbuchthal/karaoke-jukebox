...
(function() {
  ...
  angular.module("kvoxapp").controller("RendererCtrl", ["$interval", "$http",  function($interval, $http) {
    var vm = this;
    var queue = {
      user: {
        id: "57394578394579",
    ...
    // var user = socket.queue[0].user;
    // var song = socket.queue[0].song;
    var user = queue.user;
    var song = queue.song;
    var audio = document.getElementById("player");
    var mp3Path = "http://localhost:5678/"

    var lyricArray, renderedArray, unrenderedArray, currentLyric, timeoutId;
    ...
    audio.addEventListener("ended", function() {
      // Delete object off top of queue and retrieve next one
      resetSong();
    });
